...
<body>
    <div class="container-scroller">
        ...
        <nav class="navbar default-layout col-lg-12 col-12 p-0 fixed-top d-flex align-items-top flex-row">
            ...
            <div class="navbar-menu-wrapper d-flex align-items-top">
                <ul class="navbar-nav">
                    <li class="nav-item font-weight-semibold d-none d-lg-block ms-0">
                        ...
                        <p>Silahkan pilih menu yg kamu suka, kalu sudah melakukan pemesan silahkan ke kasir untuk pembayan, agar pesanan bisa di peroses </p>
                    </li>
                </ul>
            ...
            <button type="button" class="btn btn-primary" onclick="toggleFullView()">Lihat Meja Penuh</button>
        </div>
        <!-- partial -->
        <div class="container-fluid page-body-wrapper">
            ...
            <div class="main-panel" style="margin-left: auto; margin-right:auto;">
                <?php if ($makanan) : ?>
                    ...
                    <!-- Toggle Full View Script -->
    <script>
    function toggleFullView() {
        const contentWrappers = document.querySelectorAll('.content-wrapper');
        contentWrappers.forEach(wrapper => wrapper.classList.toggle('full-view'));

        const button = document.querySelector("button[onclick='toggleFullView()']");
        button.innerText = button.innerText === 'Lihat Meja Penuh' ? 'Lihat Meja Ringkas' : 'Lihat Meja Penuh';
    }
    </script>
    ...
    <style>
        ...
        /* Full view when .full-view class is added */
        .full-view .row .col-lg-3 {
